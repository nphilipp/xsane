...
#define WINDOW_SCANNER_REFL_ICM_PROFILE			_("select scanner reflective ICM-profile")
#define WINDOW_SCANNER_TRAN_ICM_PROFILE			_("select scanner transmissive ICM-profile")
...
#define RADIO_BUTTON_EMBED_ICM_PROFILE			_("Embed scanner/source ICM profile into image file")
...
#define TEXT_SETUP_SCANNER_REFL_ICM_PROFILE		_("Scanner reflective ICM-profile")
#define TEXT_SETUP_SCANNER_TRAN_ICM_PROFILE		_("Scanner transmissive ICM-profile")
...
#define DESC_EMBED_ICM_PROFILE		_("Embed scanner/source ICM profile into image file - when fileformat supports it")
...
#define DESC_SCANNER_REFL_ICM_PROFILE			_("Scanner reflektive ICM-profile")
#define DESC_BUTTON_SCANNER_REFL_ICM_PROFILE_BROWSE	_("Browse for scanner reflektive ICM-profile")
#define DESC_SCANNER_TRAN_ICM_PROFILE			_("Scanner transmissive ICM-profile")
#define DESC_BUTTON_SCANNER_TRAN_ICM_PROFILE_BROWSE	_("Browse for scanner transmissive ICM-profile")
...
#define CMS_SCANNER_TRAN_ICM		_("scanner transmissive ICM profile")
#define CMS_SCANNER_REFL_ICM		_("scanner reflective ICM profile")
